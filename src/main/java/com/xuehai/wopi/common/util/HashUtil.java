 ...
 * @Author: chenyj
 * @Description:
 * @Date: Create in 2018-03-01 11:45
 */
public class HashUtil {
     ...
     */
    public static String md5HashCode(String filePath, String hashType) throws FileNotFoundException {
        FileInputStream fis = new FileInputStream(filePath);
        return md5HashCode(fis, hashType);
    }
     ...
     * @throws FileNotFoundException
     */
    public static String md5HashCode32(String filePath, String hashType) throws FileNotFoundException{
        FileInputStream fis = new FileInputStream(filePath);
        return md5HashCode32(fis, hashType);
    }
     ...
     * @return
     */
    public static String md5HashCode(InputStream fis, String hashType) {
        try {
            //拿到一个Hash转换器,MD5,SHA-1或SHA-256
     ...
     * @return
     */
    public static String md5HashCode32(InputStream fis, String hashType) {
        try {
